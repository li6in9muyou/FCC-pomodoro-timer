...
<audio id="beep" preload="auto" src={beep_uri}>
  <track kind="captions" src={beep_uri} />
</audio>
<p
  id="timer-label"
  class="timer-display"
...
<p id="time-left" class="timer-display" class:timer-display__running={running}>
  {showCountdown($CURRENT_TIMER[period_name])}
</p>
<Controls {running} on:toggle={toggleRunning} on:reset={resetTimer} />
